...
.code
	...
	displayString	ProgramName			;prints program name
	call			CrLf
	displayString	AuthorName			;prints program author
	call			CrLf
	call			CrLf
	displayString	Introduction1 		;prints user instructions
	call			CrLf
